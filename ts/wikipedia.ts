...
const formInputDOM = document.querySelector(".form-input") as HTMLInputElement;
const resultsDOM = document.querySelector(".results") as HTMLDivElement;
...
const fetchPages = async (value: string) => {
...
const renderResultData = (list: any) => {
